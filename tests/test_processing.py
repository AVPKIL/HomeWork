...
@pytest.mark.parametrize("input_data, state, expected_ids", [
    # Стандартные случаи
    ([
...
def test_filter_by_state(input_data, state, expected_ids):
...
VALID_DATE = [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                    {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                    {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                    {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'}]

DUPLICATE_DATES = [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                    {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                    {'id': 594226727, 'state': 'CANCELED', 'date': '2019-07-03T18:35:29.512364'},  # Полное совпадение с id 41428829
                    {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'}]

INVALID_DATES = [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03'}, # Без времени
                 {'id': 615064591, 'state': 'CANCELED', 'date': '14.04.2023'}, # Неправильный формат
                 {'id': 594226727, 'state': 'CANCELED', 'date': 'September 12, 2018'}]  # Текстовый формат


def test_sort_valid_dates():
    """Тесты для корректных дат"""
    # По убыванию (reverse=True)
    assert sort_by_date(VALID_DATE, True) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                              {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                                              {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                                              {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]
    ...
    assert sort_by_date(VALID_DATE, False) == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                                               {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                                               {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
...
def test_duplicate_dates():
    ...
    result = sort_by_date(DUPLICATE_DATES, reverse=True) == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                                                            {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                                                            {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
...
def test_no_correct_dates():
    """Тестирование сортировки при одинаковых датах"""
    result = sort_by_date(INVALID_DATES, reverse=True) == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                                                            {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                                                            {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                                            {'id': 594226727, 'state': 'CANCELED', 'date': '2019-07-03T18:35:29.512364'}]